...
class PerformanceMetrics:
    ...
    @staticmethod
    def compute_settling_time(time_grid: list, errors: list, attack_end_time: float = 22.0, threshold: float = 1.5) -> float:
        """
        Calculates the recovery settling time after an attack window.
        Returns the duration (in seconds) it takes for the error to return and remain below a threshold.
        """
